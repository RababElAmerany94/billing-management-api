namespace Microsoft.AspNetCore.Authentication.CompanySquadAuth
{
    ...
    /// </summary>
    public class CompanySquadAuthOptions : AuthenticationSchemeOptions
    {
        /// <summary>
        ...
        /// </value>
        public string Audience { get; set; } = "CompanySquad.com";

        /// <summary>
        /// Gets or sets the challenge to put in the "WWW-Authenticate" header.
        /// </summary>
        public string Challenge { get; set; } = CompanySquadAuthDefaults.AuthenticationScheme;
        ...
        /// </summary>
        public new CompanySquadAuthEvents Events
        {
            get { return (CompanySquadAuthEvents)base.Events; }
