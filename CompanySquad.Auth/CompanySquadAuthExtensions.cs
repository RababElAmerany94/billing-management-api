namespace Microsoft.AspNetCore.Authentication.CompanySquadAuth
{
    ...
    /// </summary>
    public static class CompanySquadAuthExtensions
    {
        #region AuthenticationBuilder Extensions
        /// <summary>
        /// add the AddCompanySquadAuth to AuthenticationBuilder
        /// </summary>
        /// <param name="builder">the AuthenticationBuilder</param>
        /// <returns><see cref="AuthenticationBuilder"/></returns>
        public static AuthenticationBuilder AddCompanySquadAuth(this AuthenticationBuilder builder)
            => AddCompanySquadAuth(builder, CompanySquadAuthDefaults.AuthenticationScheme, _ => { });
        ...
        /// <returns><see cref="AuthenticationBuilder"/></returns>
        public static AuthenticationBuilder AddCompanySquadAuth(this AuthenticationBuilder builder, string authenticationScheme)
            => AddCompanySquadAuth(builder, authenticationScheme, _ => { });
        ...
        /// <returns><see cref="AuthenticationBuilder"/></returns>
        public static AuthenticationBuilder AddCompanySquadAuth(this AuthenticationBuilder builder, Action<CompanySquadAuthOptions> configureOptions)
            => AddCompanySquadAuth(builder, CompanySquadAuthDefaults.AuthenticationScheme, configureOptions);
        ...
        /// <param name="configureOptions">the YiSo Configure Options object</param>
        /// <returns><see cref="AuthenticationBuilder"/></returns>
        public static AuthenticationBuilder AddCompanySquadAuth(this AuthenticationBuilder builder, string authenticationScheme, Action<CompanySquadAuthOptions> configureOptions)
        {
            builder.Services.AddSingleton<IPostConfigureOptions<CompanySquadAuthOptions>, CompanySquadPostConfigureOptions>();

            return builder.AddScheme<CompanySquadAuthOptions, CompanySquadAuthHandler>(
