...
{
    public class InovaSquadAuthHandler : SignInAuthenticationHandler<InovaSquadAuthOptions>
    {
        public InovaSquadAuthHandler(
            IOptionsMonitor<InovaSquadAuthOptions> options, 
        ...
        /// </summary>
        protected new InovaSquadAuthEvents Events
        {
            get => (InovaSquadAuthEvents)base.Events;
            set => base.Events = value;
        }

        protected override Task<object> CreateEventsAsync() => Task.FromResult<object>(new InovaSquadAuthEvents());
        ...
        protected override async Task HandleChallengeAsync(AuthenticationProperties properties)
        {
            ...
            var eventContext = new InovaSquadChallengeContext(Context, Scheme, Options, properties)
            {
