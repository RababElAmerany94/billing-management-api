namespace COMPANY.Domain.Entities.OwnedEntities
{
    ...
    /// <summary>
    /// a class describe constat des planchers
    /// </summary>
    public class ConstatPlanchers
    {
        /// <summary>
        ...
        /// <summary>
        /// conclusion isolation planchers (SATISFAISANT, NON SATISFAISANT)
        /// </summary>
        public bool? ConclusionIsolationPlanchers { get; set; }
    }
}
