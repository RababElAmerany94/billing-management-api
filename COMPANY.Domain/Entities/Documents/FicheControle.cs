namespace COMPANY.Domain.Entities
{
    ...
    /// <summary>
    /// a class describe fiche controle entity
    /// </summary>
    public class FicheControle : Entity<string>
    {
        public FicheControle()
        {
            Id = Common.Helpers.IdentityDocument.Generate("FicheControle");
        ...
        /// </summary>
        public DossierPV DossierPV { get; set; }
