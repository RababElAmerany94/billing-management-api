namespace COMPANY.Application.Models.BusinessEntities.Documents.FicheControle
{
    ...
    /// <summary>
    /// a class describe fiche control create model
    /// </summary>
    public class FicheControleCreateModel
    {
        /// <summary>
        ...
        /// <summary>
        /// the dossier PV id associate with fiche controle
        /// </summary>
        public string DossierPVId { get; set; }
