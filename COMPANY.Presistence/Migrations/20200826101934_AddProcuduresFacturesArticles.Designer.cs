...
namespace COMPANY.Presistence.Migrations
{
    ...
    [Migration("20200826101934_AddProcuduresFacturesArticles")]
    partial class AddProcuduresFacturesArticles
    {
            ...
            modelBuilder.Entity("COMPANY.Domain.Entities.Parameters.TacheType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "TacheType::2", CreatedOn = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), Name = "Appel" }
                    );
                });
