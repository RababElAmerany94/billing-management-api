...
namespace COMPANY.Presistence.Migrations
{
    ...
    [Migration("20201005112158_AddEntityAgendaCommercial")]
    partial class AddEntityAgendaCommercial
    {
            ...
            modelBuilder.Entity("COMPANY.Domain.Entities.EchangeCommercial", b =>
                {
                    ...
                    b.Property<string>("AgendaEvenementId")
                        .HasMaxLength(256);
            ...
            modelBuilder.Entity("COMPANY.Domain.Entities.EchangeCommercial", b =>
                {
                    ...
                    b.HasOne("COMPANY.Domain.Entities.Parameters.AgendaEvenement", "AgendaEvenement")
                        .WithMany("EchangeCommercials")
                        .HasForeignKey("AgendaEvenementId")
                        .OnDelete(DeleteBehavior.Restrict);
